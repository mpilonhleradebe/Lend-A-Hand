 ...
 */
export declare const processTransition: (flow: Flow, path: keyof Flow, params: Params, goToPath: (pathToGo: string) => boolean, setTimeoutId: (timeoutId: ReturnType<typeof setTimeout>) => void) => Promise<void>;
